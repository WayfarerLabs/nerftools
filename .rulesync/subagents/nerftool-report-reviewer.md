...
targets: ["*"]
description: >-
  Use this agent to triage agent-filed nerf-report entries under `~/.nerftools/<brand>/reports/`.
  The agent reads matching reports, groups them by kind and tool, surfaces themes and high-priority
  items, and archives what it processed. Useful when you want a digest of agent feedback without
  loading every report's body into the main context.
---
