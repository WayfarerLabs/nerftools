...
# Other-scope work runs before the current-scope check -- with
# --reset-other-scopes, we still want to clean up other scopes even if the
# current scope has no settings file.
