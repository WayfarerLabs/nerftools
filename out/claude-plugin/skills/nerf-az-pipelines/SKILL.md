...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-list [--project|-p <project>] [-C <directory>]`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-runs [--project|-p <project>] [-C <directory>]`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-check [--project|-p <project>] [-C <directory>] <pipeline_id>`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-run-show [--project|-p <project>] [-C <directory>] <run_id>`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-run-timeline [--json] [--project|-p <project>] [-C <directory>] <run_id>`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-pipelines/scripts/nerf-az-pipelines-run-log [--full] [--errors-only] [--tail <tail>] [--project|-p <project>] [-C <directory>] <run_id> <log_id>`
