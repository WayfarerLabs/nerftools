...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-repos/scripts/nerf-az-repos-pr-create [--draft] [--target-branch|-t <target_branch>] [--project|-p <project>] <title> <description>`
...
**Usage:** `${CLAUDE_PLUGIN_ROOT}/skills/nerf-az-repos/scripts/nerf-az-repos-pr-edit [--title <title>] [--description <description>] [--project|-p <project>] <pr_id>`
