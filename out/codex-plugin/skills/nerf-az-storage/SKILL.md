...
**Usage:** `scripts/nerf-az-storage-account-list [--resource-group|-g <resource_group>] [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-storage-account-show --resource-group|-g <resource_group> [--subscription <subscription>] <name>`
...
**Usage:** `scripts/nerf-az-storage-account-network-rule-list --resource-group|-g <resource_group> [--subscription <subscription>] <account_name>`
