...
**Usage:** `scripts/nerf-git-add [-C <directory>] <files...>`
...
**Usage:** `scripts/nerf-git-revert [-C <directory>] <ref>`
...
**Usage:** `scripts/nerf-git-reset-hard-last [-C <directory>]`
...
**Usage:** `scripts/nerf-git-fetch [-C <directory>] <remote>`
...
**Usage:** `scripts/nerf-git-pull [-C <directory>] <remote>`
...
**Usage:** `scripts/nerf-git-push-main [-C <directory>] <remote>`
...
**Usage:** `scripts/nerf-git-tag [-C <directory>] <tag> [<ref>]`
...
**Usage:** `scripts/nerf-git-status [-C <directory>]`
...
**Usage:** `scripts/nerf-git-branch-list-local [-C <directory>]`
...
**Usage:** `scripts/nerf-git-branch-list-remote [-C <directory>]`
...
**Usage:** `scripts/nerf-git-switch [-C <directory>] <name>`
...
**Usage:** `scripts/nerf-git-create-branch [-C <directory>] <name>`
...
**Usage:** `scripts/nerf-git-branch-checkout-remote [-C <directory>] <remote> <name>`
...
**Usage:** `scripts/nerf-git-branch-delete-merged [-C <directory>] <name>`
...
**Usage:** `scripts/nerf-git-rebase-unpushed [-C <directory>] <target>`
...
**Usage:** `scripts/nerf-git-rebase-continue [-C <directory>]`
...
**Usage:** `scripts/nerf-git-rebase-abort [-C <directory>]`
...
**Usage:** `scripts/nerf-git-reset-unpushed [--soft|-s] [-C <directory>] <target>`
