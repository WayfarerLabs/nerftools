...
**Usage:** `scripts/nerf-az-cosmosdb-list [--resource-group|-g <resource_group>] [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-cosmosdb-show --resource-group|-g <resource_group> [--subscription <subscription>] <name>`
...
**Usage:** `scripts/nerf-az-cosmosdb-database-list --resource-group|-g <resource_group> [--subscription <subscription>] <account_name>`
...
**Usage:** `scripts/nerf-az-cosmosdb-network-rule-list --resource-group|-g <resource_group> [--subscription <subscription>] <account_name>`
