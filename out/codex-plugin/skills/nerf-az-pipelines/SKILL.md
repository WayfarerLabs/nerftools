...
**Usage:** `scripts/nerf-az-pipelines-list [--project|-p <project>]`
...
**Usage:** `scripts/nerf-az-pipelines-runs [--project|-p <project>]`
...
**Usage:** `scripts/nerf-az-pipelines-check [--project|-p <project>] <pipeline_id>`
...
**Usage:** `scripts/nerf-az-pipelines-run-show [--project|-p <project>] <run_id>`
...
**Usage:** `scripts/nerf-az-pipelines-run-timeline [--json] [--project|-p <project>] <run_id>`
...
**Usage:** `scripts/nerf-az-pipelines-run-log [--full] [--errors-only] [--tail <tail>] [--project|-p <project>] <run_id> <log_id>`
