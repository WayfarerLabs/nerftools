...
**Usage:** `scripts/nerf-find [tokens...]`
**Maps to:** `find "$@"`
...
**Usage:** `scripts/nerf-find-cwd [tokens...]`
**Maps to:** `find . "$@"`
...
**Usage:** `scripts/nerf-grep-recursive-cwd [--ignore-case|-i] [--line-regexp|-x] [--word-regexp|-w] [--count|-c] [--files-with-matches|-l] [--include <include>] [--exclude <exclude>] <pattern>`
...
**Usage:** `scripts/nerf-grep [--recursive|-r] [--ignore-case|-i] [--line-regexp|-x] [--word-regexp|-w] [--count|-c] [--files-with-matches|-l] [--include <include>] [--exclude <exclude>] <pattern> <paths...>`
