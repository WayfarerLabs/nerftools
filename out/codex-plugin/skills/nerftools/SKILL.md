...
Each tool's usage line shows the path to call it relative to this skill's directory.
...
- **nerf-tf**: Terraform workflow tools for formatting and static validation
