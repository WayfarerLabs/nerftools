...
**Usage:** `scripts/nerf-az-monitor-activity-log [--resource-group|-g <resource_group>] [--resource-id <resource_id>] [--hours-back <hours_back>] [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-monitor-metrics-list --resource <resource_id> [--aggregation <aggregation>] [--interval <interval>] [--start-time <start_time>] [--end-time <end_time>] [--subscription <subscription>] <metric>`
...
**Usage:** `scripts/nerf-az-monitor-diagnostic-settings-list [--subscription <subscription>] <resource_id>`
