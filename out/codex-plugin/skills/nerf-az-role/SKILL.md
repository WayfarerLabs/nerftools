...
**Usage:** `scripts/nerf-az-role-assignment-list [--all] [--assignee <assignee>] [--scope <scope>] [--role <role>] [--resource-group|-g <resource_group>] [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-role-assignment-by-id [--subscription <subscription>] <assignment_id>`
...
**Usage:** `scripts/nerf-az-role-definition-list [--custom-role-only] [--name|-n <name>] [--scope <scope>] [--subscription <subscription>]`
