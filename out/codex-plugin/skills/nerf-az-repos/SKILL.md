...
**Usage:** `scripts/nerf-az-repos-pr-list [--status <status>] [--top <top>] [--creator <creator>] [--reviewer <reviewer>] [--project|-p <project>] [-C <directory>]`
...
**Usage:** `scripts/nerf-az-repos-pr-show [--project|-p <project>] [-C <directory>] <pr_id>`
...
**Usage:** `scripts/nerf-az-repos-pr-comments [--project|-p <project>] [-C <directory>] <pr_id>`
...
**Usage:** `scripts/nerf-az-repos-pr-create [--draft] [--target-branch|-t <target_branch>] [--project|-p <project>] [--repository|-r <repository>] [--source-branch|-s <source_branch>] [-C <directory>] <title> <description>`
...
**Usage:** `scripts/nerf-az-repos-pr-set-status [--project|-p <project>] [-C <directory>] <pr_id> <status>`
...
**Usage:** `scripts/nerf-az-repos-pr-edit [--title <title>] [--description <description>] [--draft <draft>] [--project|-p <project>] [-C <directory>] <pr_id>`
...
**Usage:** `scripts/nerf-az-repos-pr-vote [--project|-p <project>] [-C <directory>] <pr_id> <vote>`
