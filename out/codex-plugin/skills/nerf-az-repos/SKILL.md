...
**Usage:** `scripts/nerf-az-repos-pr-list [--status <status>] [--top <top>] [--creator <creator>] [--reviewer <reviewer>] [--project|-p <project>]`
...
**Usage:** `scripts/nerf-az-repos-pr-show [--project|-p <project>] <pr_id>`
...
**Usage:** `scripts/nerf-az-repos-pr-comments [--project|-p <project>] <pr_id>`
...
**Usage:** `scripts/nerf-az-repos-pr-set-status [--project|-p <project>] <pr_id> <status>`
...
**Usage:** `scripts/nerf-az-repos-pr-vote [--project|-p <project>] <pr_id> <vote>`
