...
**Usage:** `scripts/nerf-nx-show-projects`
...
**Usage:** `scripts/nerf-nx-show-project <project>`
...
**Usage:** `scripts/nerf-nx-run <target>`
...
**Usage:** `scripts/nerf-nx-affected`
