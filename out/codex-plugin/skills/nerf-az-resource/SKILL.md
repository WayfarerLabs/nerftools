...
**Usage:** `scripts/nerf-az-resource-list [--resource-group|-g <resource_group>] [--resource-type <resource_type>] [--tag <tag>] [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-resource-show [--subscription <subscription>] <resource_id>`
...
**Usage:** `scripts/nerf-az-group-list [--subscription <subscription>]`
...
**Usage:** `scripts/nerf-az-group-show [--subscription <subscription>] <name>`
