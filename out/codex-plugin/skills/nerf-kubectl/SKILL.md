...
**Usage:** `scripts/nerf-kubectl-version`
...
**Usage:** `scripts/nerf-kubectl-config-get-contexts`
...
**Usage:** `scripts/nerf-kubectl-config-current-context`
...
**Usage:** `scripts/nerf-kubectl-config-use-context <context>`
...
**Usage:** `scripts/nerf-kubectl-cluster-info`
...
**Usage:** `scripts/nerf-kubectl-get [--all-namespaces|-A] [--show-labels] [--namespace|-n <namespace>] [--selector|-l <selector>] [--field-selector <field_selector>] <resource> [<name>]`
...
**Usage:** `scripts/nerf-kubectl-get-secrets [--all-namespaces|-A] [--namespace|-n <namespace>] [--selector|-l <selector>] [<name>]`
...
**Usage:** `scripts/nerf-kubectl-describe [--namespace|-n <namespace>] <resource> <name>`
...
**Usage:** `scripts/nerf-kubectl-logs [--previous|-p] [--namespace|-n <namespace>] [--container|-c <container>] [--tail <tail>] <pod>`
...
**Usage:** `scripts/nerf-kubectl-top-pods [--all-namespaces|-A] [--namespace|-n <namespace>] [--selector|-l <selector>]`
...
**Usage:** `scripts/nerf-kubectl-top-nodes [--selector|-l <selector>]`
...
**Usage:** `scripts/nerf-kubectl-api-resources [--api-group <api_group>]`
...
**Usage:** `scripts/nerf-kubectl-api-versions`
...
**Usage:** `scripts/nerf-kubectl-explain [--recursive] <resource>`
...
**Usage:** `scripts/nerf-kubectl-exec [--namespace|-n <namespace>] [--container|-c <container>] <pod> <command...>`
...
**Usage:** `scripts/nerf-kubectl-port-forward --timeout-seconds <timeout_seconds> [--namespace|-n <namespace>] <target> <ports>`
...
**Usage:** `scripts/nerf-kubectl-rollout-restart [--namespace|-n <namespace>] <target>`
